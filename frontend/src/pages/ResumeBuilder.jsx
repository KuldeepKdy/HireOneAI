    ...
    <div className="min-h-screen bg-white text-[#0A0A0A] flex flex-col">
      ...
      >
        <div className="mx-auto flex h-12 max-w-7xl items-center justify-between px-3 sm:px-5">
          ...
          <button className="flex h-8 items-center justify-center rounded-lg border border-black/15 text-black/60 transition px-2 hover:border-[#A0A0A0] hover:text-[#0A0A0A]">
            <FiEye size={13} />
          </button>
        </div>
      </motion.nav>
        ...
        <div className="mx-auto w-full max-w-2xl">
          ...
          <div className="flex items-center justify-between">
            <button
              ...
              className={`flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-medium border transition-all ${currentStep === 1 ? "border-black/8 text-black/25 cursor-not-allowed" : "border-black/20 text-black/60 hover:border-black/40 hover:text-[#0A0A0A]"}`}
            >
              <FiArrowLeft size={15} />
      ...
      text-xs font-semibold bg-[#000000]/90 backdrop-blur-2xl border
      border-white/10 text-white shadow-[0_8px_24px_rgba(0,0,0,0.25)]
